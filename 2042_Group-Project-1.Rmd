...
ICC_class<-280.69/(280.69+1146.79+85.47)
ICC_school<- 85.47/(85.47+1146.79+280.69)
```
a)
$ICC_{school}=\frac{\sigma^2_\zeta}{\sigma^2_\zeta+\sigma^2_\epsilon}=\frac{85.47}{85.47+1146.79+280.69}=0.056$, $ICC_{class}=\frac{\sigma^2_\zeta}{\sigma^2_\zeta+\sigma^2_\epsilon}=\frac{280.69}{280.69+1146.79+85.47}=0.186$
