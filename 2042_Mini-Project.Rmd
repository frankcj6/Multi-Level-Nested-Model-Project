...
```
**Response:** `r slope_X_q4`.

d. Do you see any real change in the $\beta_X$ estimate? Does a 95% confidence band for this coefficient estimate cover the “truth” that you used to generate the data? 
...
Yes. The confidence band (95% of confidence) for this coefficient estimate is between `r lower` and `r upper`. This confirms that a 95% confidence band covers the "truth" of the slope, which is 1.
...
**Response:** `r slope_X_q5`.

e. Do you see any real change in the $\beta_X$ estimate? 

**Response:** No. The $\beta_X$ estimate of the model with missing data values is `r slope_X_q5`, which is very close to the original estimate, `r slope_X_q2`.
